...
var speaker;
var audio;
var audio_1,audio_2,audio_3,audio_4;
...
function draw() {
  ...
  run = random(1,4);
      ...
      if(GameState === "MAINPAGE"){
        ...
        text("5) Click Check Your Result After Writing In Input.",70,320);
        ...
        text("9) Listen This Audio At Volume Of Level 4 In Your Device.",720,290);
        text("10) Write The Words Without Spelling Mistake",720,320);
        textSize(15);
        fill("black");
